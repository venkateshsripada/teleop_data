#include <franka_teleoperation/franka_leader_impendance_controller.h>
...
bool LeaderCartesianImpedanceController::init(hardware_interface::RobotHW* robot_hw,
  ...
  dynamic_server_compliance_param_ = std::make_unique<
      dynamic_reconfigure::Server<franka_teleoperation::panda_leader_compliance_paramConfig>>(
...
void LeaderCartesianImpedanceController::complianceParamCallback(
    franka_teleoperation::panda_leader_compliance_paramConfig& config,
    uint32_t /*level*/) {
...
PLUGINLIB_EXPORT_CLASS(franka_teleoperation::LeaderCartesianImpedanceController,
